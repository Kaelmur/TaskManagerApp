  ...
  const getAllPlans = async (status: string) => {
    try {
      ...
      const statusArray = [
        ...
        { label: "Active", count: statusSummary.activePlans || 0 },
        { label: "Completed", count: statusSummary.completedPlans || 0 },
      ];
      ...
      <div className="my-5">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between">
          <div className="flex items-center justify-between gap-3">
            <h2 className="text-xl md:text-xl font-medium">Plans</h2>
